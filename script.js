const DATA = [
{s:"Crimes Hediondos", f:"Crimes equiparados a hediondos", b:"Tortura,\ntráfico de drogas,\nterrorismo"},
...
{s:"Direito Administrativo", f:"Inexigibilidade de licitação", b:"Não há possibilidade de competição, pois a própria natureza do objeto/serviço não permite a licitação"},
...
{s:"Direito Penal Militar", f:"CPPM — fiança", b:"O CPPM não admite fiança"},
