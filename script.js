...
{s:"Direito Constitucional", f:"Distrito Federal — competência legislativa", b:"O Distrito Federal legisla tanto como Estado quanto como Município"},{s:"Direito Constitucional", f:"Inafiançável, imprescritível, insuscetível", b:"Inafiançável → não admite fiança\nImprescritível → não perde validade com o tempo\nInsuscetível de graça ou anistia → não pode receber indulto/perdão"},
...
{s:"Infotmática", f:"Malweres",b:"Um worm infecta a rede e não os arquivos"},
...
{s:"Português", f:"Termos acessórios — Vocativos", f:"Aposto explicativo → Explica ou esclarece um termo anterior.Sempre vem entre vírgulas, travessões ou parênteses\nAposto especificativo → Especifica ou identifica um nome, sem uso de vírgulas." },
