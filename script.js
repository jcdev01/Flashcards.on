const DATA = [
{s:"Conhecimentos Gerais", f:"Clima", b:"O clima consiste em tropical úmido e semiárido"},
{s:"Conhecimentos Gerais", f:"Emacipação política", b:"Teve início com a criação da comarca de Alagoas em 1711\nEm 1817 é assinado o decreto separando Alagoas de Pernambuco\nEm 1819,posse do 1° governador"},
{s:"Conhecimentos Gerais", f:"Invasões Estrangeiras", b:"Franceses →início no século XVI,teve como objetivo a extração do pau Brasil via escambo\nHolandeses → Início no século XVII,teve como objetivo o controle do lucro da cana-de-açucar"},
{s:"Conhecimentos Gerais", f:"Modelo Platation", b:"Monocultura → Uma só cultura (cana de açucar)\nLatifúndio → grandes extensões de terra concentradas nas mãos de poucos senhores de engenho\nEscravidão → Trabalho forçado,primeiramente por índios e dps por africanos\nExportação → Foco no mercado europeu"},
{s:"Conhecimentos Gerais", f:"Regiões de Alagoas", b:"Litoral\nZona da mata\nAgreste(Zona de transição)\nSertão"},
{s:"Conhecimentos Gerais", f:"Setores econômicos", b:"Setor terceario → 70%,setor de serviços(turismo e comercio)\nSetor secundario →Em torno de 20%,setor indutrial(industria sucroalcooleira)\nSetor primario →em torno de 10%,setor agropecuário"},
...
{s:"Direito Administrativo", f:"Atos administrativos  principais", b:"Licença → Administração reconhece ao particular o direito de exercer uma atividade, desde que preenchidos os requisitos legais(licença do particular)\nPermissão → a Administração permite ao particular utilizar um bem público ou prestar determinado serviço(uso de bem público ou prestação de serviço)\nAutorização → a Administração permite que o particular exerça uma atividade ou utilize um bem público(permissão por conveiência da administração\nParecer → Um orgão público ou gente competente emite uma opinião técnica ou jurídica sobre determinado assunto"},
{s:"Direito Administrativo", f:"Atributos dos atos administrativos", b:"Presunção (de legitimidade) → Todo ato administrativo presume-se legal e verdadeiro até prova em contrário.\nImperatividade → permite à Administração impor obrigações ao administrado independentemente de sua concordância.\nAutoexecutoriedade → Permite que a Administração execute diretamente o ato, sem precisar de autorização judicial prévia.\nTipicidade → o ato administrativo deve corresponder a um tipo previsto em le"},
...
{s:"Direito Administrativo", f:"Controle da Administração Pública", b:"Controle interno → exercido pelo próprio Poder Público, por meio de órgãos internos\nControle externo → exercido por órgãos independentes do Poder Público, como o Tribunal de Contas e o Poder Legislativo"},
{s:"Direito Administrativo", f:"Controle da Administração Pública", b:"Apenas a Constituição Federal pode prever modalidades de controle externo"},
{s:"Direito Administrativo", f:"Controle da Administração Pública — Formas", b:"Preventiva → antes do ato \nConcomitante → Durante a execução do ato\nCorretivo(repressivo) → depois do ato administrativo"},
...
{s:"Direito Administrativo", f:"Licitação — troca de fases", b:"A Administração pode inverter a ordem das fases de habilitação e julgamento, desde que haja motivação e previsão no edital."},
{s:"Direito Administrativo", f:"Modalidades de licitação", b:"Concorrência → De bens e serviços especiais e de obras e serviços comuns e especiais de engenharia\nConcurso → trabalhos técnicos, científicos ou artísticos\nLeilão → venda de bens móveis e imóveis\nPregão → bens e serviços comuns\nDiálogo competitivo → bens e serviços complexos"},
...
{s:"Direito Constitucional", f:"Inviolabilidade", b:"Apenas a violabilidade das comunicações telefônicas poderá ser quebrada por decisão judicial para fins de investigação criminal ou instrução processual penal."},
...
{s:"Direito Penal Militar", f:"Livramento condicional — Condições", b:"Pena de reclusão ou detenção não superior a 2 anos\nMetade da pena,se primário\n2/3 da pena de reincidente\nTenha reparado,salvo a impossibilidade de faze-lo,o dano causado\nBoa contuda"},
...
{s:"Direito Penal Militar", f:"Teoria — Lugar do crime", b:"O cpm adota a teoria da ubuqidade para o local do crime nos crimes comissivos e da atividade para os crimes omissivos"},
...
{s:"Direito Processual Penal", f:"Ação subsidiária da pública", b:"É admitida a açao penal subsidiária da pública quando há incercia do ministério(não oferece a denúncia no prazo legal)"},
...
{s:"Direito Processual Penal", f:"Tentativa", b:"Pune-se a tentativa com a pena correspondente ao crime, diminuída de um a dois terços,no cpm é possível que o juíz aplique a pena de crime consumado"},
{s:"Direito Processual Penal Militar", f:"Inquerito", b:"A autoridade judiciária(juiz) não pode requisitar a instauração do inquerito"},
{s:"Direito Processual Penal Militar", f:"Inquerito — desarquivamento", b:"O arquivamento de inquérito não obsta a instauração de outro\n\nDesarquivamento → reabre oque já existia\nNovo inquérito → Instaura-se outro para investgar o mesmo fato"},
{s:"Direito Processual Penal Militar", f:"Inquerito — prazos de denúncia e inquérito", b:"Denúncia → réu preso: 5 dias / solto: 15 dias\nInquérito(contados a partit da ordem de prisão) → réu preso: 20 dias / solto: 40 dias (prorrogável)"},
{s:"Direito Processual Penal Militar", f:"Interpretação da lei", b:"Interpretação extensiva → Quando a lei é mais estreita\nInterpretação restritiva → Quando a lei é mais ampla"},
{s:"Direito Processual Penal Militar", f:"Liberdade Provisória", b:"O indiciado ou acusado livrar-se-á solto no caso de infração a que não for cominada pena privativa de liberdade."},
{s:"Direito Processual Penal Militar", f:"Menagem", b:"A menagem poderá ser concedida pelo juiz, nos crimes cujo máximo da pena privativa da liberdade não exceda a quatro anos, tendo-se, porém, em atenção a natureza do crime e os antecedentes do acusado."},
{s:"Direito Processual Penal Militar", f:"Processo Penal Militar — fiança", b:"O CPPM não admite fiança"},
{s:"Direitos Humanos", f:"Características dos direitos humanos", b:"Universais → aplicáveis a todos os seres humanos\nIndivisíveis → não podem ser separados\nInalienáveis → não podem ser retirados\nInterdependentes → dependem uns dos outros\nImprescritíveis → não perdem validade com o tempo\nIrrenunciáveis → não podem ser renunciados\nHistóricos → surgem e evoluem com o tempo\nRelativos → dependem do contexto histórico, social e cultural"},
{s:"Direitos Humanos", f:"Comissão Interamericana", b:"Possui 7 membros com mandato de 4 anos, podendo ser reeleitos por mais 4 anos\nPodem ir a comissão qualquer pessoas,grupos de pessoas e entidades não gorvernamentais"},
{s:"Direitos Humanos", f:"Corte Interamericana", b:"Possui 7 membros com mandato de 6 anos, podendo ser reeleitos por mais 6 anos\nPodem ir a corte apenas os Estados membros da OEA"},
{s:"Direitos Humanos", f:"DUDH", b:"A Declaração Universal dos Direitos Humanos (DUDH) foi adotada pela Assembleia Geral da ONU em 10 de dezembro de 1948, como resposta às atrocidades da Segunda Guerra Mundial.Seu objetivo é estabelecer um padrão mínimo de direitos e liberdades fundamentais para todas as pessoas."},
{s:"Direitos Humanos", f:"DUDH — características", b:"A DUDH contempla expressamente  direitos  de 1° e 2° gerações, mas não de 3° geração, que surgiram posteriormente."},
{s:"Direitos Humanos", f:"Emendas Constitucionais", b:"Os tratados e convenções internacionais sobre direitos humanos que forem aprovados, em CADA CASA do Congresso Nacional, em DOIS TURNOS, por 3/5 dos votos de seus membros serão equivalentes às emendas constitucionais."},
{s:"Direitos Humanos", f:"gerações de direitos humanos", b:"1ª geração → direitos civis e políticos(liberdade)\n2ª geração → direitos econômicos, sociais e culturais(igualdade)\n3ª geração → direitos difusos e coletivos(fraternidade ou solidariedade)"},
...
{s:"Informática", f:"Power point — Extenções", b:"Potx → Modelo\nPptx → Formato padrão"},
{s:"Legislação da PM", f:"Agregação", b:"A agregação é a situação na qual o policial-militar da ativa deixa de ocupar vaga na escala hierárquica de seu quadro ou Qualificação, nela permanecendo sem número."},
{s:"Legislação da PM", f:"Apuração de transgressões", b:"Parte disciplinar → Documento que narra transgressão de policial de posto ou graduação inferior\nComunicação disciplinar → Documento que narra transgressão de superior hierarquico"},
{s:"Legislação da PM", f:"Ausente Deserção Desaparecimento Extravio", b:"Ausente → 24 horas sem comunicar a ausência\nDeserção → Mais de 8 dias sem comunicar a ausência\nDesaparecido → mais de 8 dias (em serviço, operação policial-militar, viagem, calamidade pública ou outra situação semelhante)\nExtravio → 30 dias desaparecido,"},
{s:"Legislação da PM", f:"Classificação comportamental", b:"Excepcional\nÓtimo\nBom\nInsuficiente\nMau → quebra de expectativa"},
{s:"Legislação da PM", f:"Conselho de justificação x disciplina", b:"Oficial → Conselho de Justificação\nPraça → Conselho de Disciplina"},
{s:"Legislação da PM", f:"Deserção", b:"Se o policial militar for oficial ou praça com estabilidade, deverá ele ser agregado e após 6 meses de agregação não havendo captura ou apresentação deverá ele ser demitido ou excluido\nA praça sem estabilidade deverá ser automaticamente excluida"},
{s:"Legislação da PM", f:"Inatividade — prazos", b:"Pensão → 35 anos, com 30 de serviço ativo\nReserva → 30 anos\nReforma → 12 anos"},
{s:"Legislação da PM", f:"Termos de promoção", b:"Antiguidade, Merecimento, Bravura, Post Mortem"},
{s:"Legislação da PM", f:"Transgressões disciplinares e Detenção", b:"A pena máxima para transgressão disciplinar é a detenção, que pode ser aplicada por até 30 dias, podendo ser convertida em multa ou suspensão de soldo"},
{s:"Legislação Especial", f:"Abuso de Autoridade — efeitos da condenação", b:"Obrigação de reparar o dano causado → automático\nInabilitação para o cargo → se reincidente\nPerda do cargo/mandato/função pública → se reincidente"},
{s:"Legislação Especial", f:"Abuso de Autoridade — Modalidades", b:"A lei de abuso de autoridade não admite a modalidade culposa,exige dolo específico"},
{s:"Legislação Especial", f:"Abuso de Autoridade",b:"A lei de abuso de autoridade não tem a pena de reclusão, apenas detenção, e sempre uma multa junto"},
...
{s:"Legislação Especial", f:"Codigo de Trânsito — Vias rurais", b:"Rodovias → pavimentadas\nEstradas → não pavimentadas"},
{s:"Legislação Especial", f:"Codigo de Trânsito — Vias urbanas", b:"Via de trânsito rápido → sem cruzamentos, fluxo livre\nVia arterial → liga regiões da cidade\nVia local → acesso à residência"},
{s:"Legislação Especial", f:"Crimes ambientais", b:"A lei de crimes ambientais e de ação pública incondicionada"},
{s:"Legislação Especial", f:"Crimes ambientais — Incorporação de pessoa júridica", b:"A incorporação de uma pessoa jurídica por outra não transfere automaticamente a responsabilidade penal pelos crimes ambientais praticados pela empresa incorporada"},
...
{s:"Legislação Especial", f:"Crimes hediondos — Crimes contra a dignidade sexual ", b:"Diferentemente dos crimes de estúpro,estúpro de vunerável e favorecimento à prostituição, os crimes de assédio sexual e importunação sexual não são considerados hediondos"},
...
{s:"Legislação Especial", f:"Estatuto do Desarmamento — idade mínima", b:"A idade mínima para aquisição de arma de fogo é de 25 anos,execeto os integrantes dos órgão de segurança pública e das forças armadas"},
...
{s:"Legislação Especial", f:"Estatuto do Desarmamento — Uso restrito", b:"Raspar,suprimir e adulterar a numeração da arma irá transformar a arma para arma de uso restrito"},
...
{s:"Legislação Especial", f:"Lei de drogas — Ação controlada", b:"A ação controlada na lei de drogas precisa de autorização judicial e previa oitiva do mp"},
...
{s:"Legislação Especial", f:"Jecrim  — rejeita de denúncia ou queixa",b:"O recurso cabível pela rejeição da queixa-crime no procedimento dos juizados especiais criminais é a apelação"},
{s:"Legislação Especial", f:"Jecrim ", b:"O crime será processado pelo jecrim quando:\nFor uma contravenção penal(todas elas)\nFor um crime com pena máxima de até 2 anos."},
{s:"Legislação Especial", f:"Maria da penha —  Formas de violência", b:"Física → Qualquer conduto que ofenda a integridade ou saúde corporal da mulher\nPsicológica → Qualquer conduta que cause dano emocional ou diminuição da autoestima\nSexual → Qualquer conduta que force a mulher a participar de relação sexual\nPatrimonial → Qualquer conduta que cause retenção,subtração ou destruição de bens da mulher\nMoral →Qualquer conduta que configures crimes contra a honra\nVicária → Qualquer forma de violência praticada contra ascendente ou descendente"},
{s:"Legislação Especial", f:"Maria da penha — Afastamento", b:"O afastamento poderá ser determinado:\nPela autoridade judicial\nPelo delegado se o município não for sede da comarca,pelo polocia de o munícipio não for sede da comarca e não houver delegado disponível no momento da denúncia"},
...
{s:"Legislação Especial", f:"Prisão temporária — execução ", b:"Só pode ser executada depois do mandado judicial,não sendo adimitida em flagrante"},
{s:"Legislação Especial", f:"Prisão  — Juiz",b:"O juíz não pode decrata-la de ofício"},
{s:"Legislação Especial", f:"Rol dos crimes hediondos", b:"Os crimes hediondos têm rol taxativo (lista fechada)"},
{s:"Legislação Especial", f:"Tortura", b:"Não existe a modalidade culposa nos crimes de tortura"},
{s:"Legislação Especial", f:"Tortura — Efeitos", b:"A condenação acarretará a perda do cargo, função ou emprego público e ainterdição para seu exercício pelo dobro do prazo da pena aplicada"},
...
{s:"Português", f:"Termos acessórios — Vocativos", b:"Aposto explicativo → Explica ou esclarece um termo anterior.Sempre vem entre vírgulas, travessões ou parênteses\nAposto especificativo → Especifica ou identifica um nome, sem uso de vírgulas."},
...
{s:"Redação",f:"Conclusão",b:"Sempre ultilizar o investimento em politicas públicas para resolver o problema"},
